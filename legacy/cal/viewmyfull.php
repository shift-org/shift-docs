...
<div id="content" class="content">
  ...
  <a id="cal">&nbsp;</a>
    ...
    on the <a href="viewmypp.php"><?php print CALURL; ?>viewmypp.php</a> page.
<?php
$sql = "SELECT * FROM calevent, caldaily WHERE calevent.id = caldaily.id AND eventdate >= '".PPSTART."' AND eventdate <= '".PPEND."' ORDER BY eventdate, eventtime";
