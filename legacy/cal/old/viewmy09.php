...
<div class=content style="margin: 5px;">
  <center>
    <h1>Custom Pedalpalooza 2009 Event List</h1>
    <a class=button style="font-size: x-small;" href="viewpp2009.php">Return to the Pedalpalooza Calendar</a>
  </center>
  <p>
  This is a simple listing of the Pedalpalooza 2009 events.
...
<?php
	...
	#print "        <a href=\"viewpp2009.php#$htmlid\" target=\"pp\"$titlecolor title=\"".htmlspecialchars($record["title"])."\">\n";
	print "        <a href=\"viewpp2009.php#$htmlid\" target=\"pp\"$titlecolor title=\"".htmlspecialchars($record["title"])."\">\n";
...
?>
  ...
  <div class="form">
    <a class=button href="viewmyfull09.php">Full descriptions</a> exactly like the main calendar view
  </div>
  ...
  <div class="form">
    <form action="viewmy09.php" method="POST" onSubmit="return confirm('Do you really want to share this list with the public?')">
...
initcheckboxes();
guesspocketmod();
document.title = "Custom Pedalpalooza 2009 Event List";
</script>
<?php
