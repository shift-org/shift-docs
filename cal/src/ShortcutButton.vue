...
export default {
  ...
  computed: {
    ...
    click() {
      return this.state.click; // returns the function; doesn't call the function.
    },
    // the state generated by buildShortcuts
    // lives as a computed property so when the shortcut function changes
    // this automatically recomputes its values.
    state() {
