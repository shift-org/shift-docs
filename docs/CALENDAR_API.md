...
* 3.50.1: (2024-05-06) Fixed handling of some boolean fields which may unexpectedly be null (hidden, highlight, printemail, etc)
* 3.50.2: (2024-05-20) Removed now-unused PHP
